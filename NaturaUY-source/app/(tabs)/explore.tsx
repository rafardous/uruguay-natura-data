...
import { ChevronRightIcon, CloseIcon, SlidersIcon, TaxonomyIcon } from '../../src/presentation/components/TabIcons';
...
export default function ExploreScreen(): React.JSX.Element {
  ...
  return <View style={[styles.screen, { backgroundColor: colors.background }]}>
    <AppHeader onOpenMenu={() => setMenuOpen(true)}><View style={styles.headerTools}><SearchBar value={query} onChange={setQuery} /><AccountButton onPress={() => router.push('/login')} color={colors.text} backgroundColor={colors.surface} /></View></AppHeader>
    ...
    {!canShowResults ? <ScrollView contentContainerStyle={{ padding: spacing.lg, gap: spacing.md, paddingBottom: bottom }} showsVerticalScrollIndicator={false}>
